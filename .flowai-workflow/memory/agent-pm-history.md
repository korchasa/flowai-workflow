...
| 20260320T223114 | #183 (engine) | ~7    | FR-E39 added | 1 candidate only. python3 str.replace() — clean insertion + appendix row in 1 call. Memory FR count was correct (FR-E38). Grep+tail in 1 turn gave full structure. |
| 20260418T184929 | #187 (engine) | ~8    | FR-E47 added | SRS split into index+section files — Read index first, then targeted section file. Edit tool works cleanly on section files (no large-file issues). §0 and §5 in 00-meta.md; CLI/obs FRs in 05-cli-and-observability.md. Detached HEAD worktree is normal. |
